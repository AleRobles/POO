 ...
 * @author Peña Robles
 */
public class MotociclistaController implements Initializable {
     @FXML
    ...
    @FXML private void calcular(ActionEvent event) throws IOException{
        ...
        Motociclista consum = new Motociclista(kilometros);
        com = consum.consumoRecorrido();
        consumo.setText(""+com+ " litros");
        Motociclista preci = new Motociclista(kilometros);
    ...
    private void guardar(ActionEvent event) {
        File archivo;
        try{
            archivo = new File("Motociclista.txt");
            if(archivo.exists()) {
